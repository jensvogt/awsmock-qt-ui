...
std::function<void()> RestManager::get(const QUrl &url, const QMap<QString, QString> &headers, std::function<void(bool, QByteArray, int, QString)> callback) {
...
std::function<void()> RestManager::Delete(const QUrl &url, const QMap<QString, QString> &headers, std::function<void(bool, QByteArray, int, QString)> callback) {
