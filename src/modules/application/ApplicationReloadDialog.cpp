...
ApplicationReloadDialog::ApplicationReloadDialog(QWidget *parent) : QDialog(parent) {
    ...
    connect(privatePortEdit, &QLineEdit::textChanged, this, &ApplicationReloadDialog::UpdateLineEditStyle);
    ...
    connect(publicPortEdit, &QLineEdit::textChanged, this, &ApplicationReloadDialog::UpdateLineEditStyle);
    ...
    connect(openButton, &QPushButton::clicked, this, &ApplicationReloadDialog::OpenFilesDialog);

    // Connect the standard signals to the dialog's built-in slots.
    connect(buttonBox->button(QDialogButtonBox::Ok), &QPushButton::clicked, this, &ApplicationReloadDialog::VerifyAllInputs);
...
ApplicationReloadDialog::~ApplicationReloadDialog() = default;

void ApplicationReloadDialog::dragEnterEvent(QDragEnterEvent *event) {
...
void ApplicationReloadDialog::dropEvent(QDropEvent *event) {
...
void ApplicationReloadDialog::OpenFilesDialog() {
...
void ApplicationReloadDialog::UpdateLineEditStyle(const QString &text) const {
    Q_UNUSED(text);
...
void ApplicationReloadDialog::VerifyAllInputs() {
    // Check name
    int pos = 0;
