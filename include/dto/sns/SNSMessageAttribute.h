#ifndef AWSMOCK_QT_UI_SNS_MESSAGE_ATTRIBUTE_H
#define AWSMOCK_QT_UI_SNS_MESSAGE_ATTRIBUTE_H
...
struct SNSMessageAttribute final {
    /**
...
#endif// AWSMOCK_QT_UI_SNS_MESSAGE_ATTRIBUTE_H
