...
#define AWSMOCK_UI_MAKE_VERSION(major, minor, patch) \
((major) * 10000 + (minor) * 100 + (patch))

#define AWSMOCK_UI_VERSION_CODE \
AWSMOCK_UI_MAKE_VERSION(AWSMOCK_UI_VERSION_MAJOR, AWSMOCK_UI_VERSION_MINOR, AWSMOCK_UI_VERSION_PATCH)
