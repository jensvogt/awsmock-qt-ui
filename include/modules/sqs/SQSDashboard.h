...
#ifndef AWSMOCK_QT_UI_SQS_DASHBOARD_H
#define AWSMOCK_QT_UI_SQS_DASHBOARD_H
...
class SQSDashboard : public BasePage {
    Q_OBJECT
...
public:
     ...
     */
    explicit SQSDashboard(QWidget *parent = nullptr);

    /**
     * @brief Destructor
     */
    ~SQSDashboard() override;
...
#endif //AWSMOCK_QT_UI_SQS_DASHBOARD_H
